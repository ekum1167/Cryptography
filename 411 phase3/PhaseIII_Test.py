...
def CheckBlock(TxCnt, Block):
    ...
    #print("1type of prev pow = ", type(PrevPoW))
    PrevPoW = PrevPoW.encode('UTF-8')
    #print("2type of prev pow = ", type(PrevPoW))
...
#print("type of prevpow in phase3 line 173 = ", type(PrevBlock))
...
for i in range(1, ChainLen):
    ...
    f.write(NewBlock)
    f.close()
    #print("PrevPoW line200 = ",PrevPoW)
    #print(" if statement = ", PrevPoW[:PoWLen])
...
for i in range(1, ChainLen):
    ...
    #print("PrevPoW_ = ", PrevPoW_)
    #print("PrevPoW = ", PrevPoW)
    print("PoW of block" + str(i)+ " = ", PoW)
    print("PrevPoW = ", PrevPoW)
    print("PrevPoW_ = ", PrevPoW_)
